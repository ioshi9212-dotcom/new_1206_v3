...
This replaces the old writer that could route dynamic knowledge into
state/character_knowledge or a monolithic state/relationships file.
"""
...
app = base.app
RUNTIME_VERSION = "0.3.181-v3-apply-turn-result-v1"
...
def apply_turn_result_v3(session_id: str, body: dict[str, Any] | None = Body(default=None)) -> dict[str, Any]:
    ...
    result = {
        ...
        "blocked_paths": ["characters/<id>/*.yaml", "runtime/characters", "state/character_knowledge", "state/relationships.json"],
        "notes": [
